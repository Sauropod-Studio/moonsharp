...
namespace MoonSharp.Interpreter.Interop
{
	...
	public interface IUserDataDescriptor
	{
		...
		/// <returns></returns>
		DynValue Index(Script script, IUserData obj, DynValue index, bool isDirectIndexing);
		/// <summary>
		...
		/// <param name="isDirectIndexing">If set to true, it's indexed with a name, if false it's indexed through brackets.</param>
		/// <returns></returns>
		bool SetIndex(Script script, IUserData obj, DynValue index, DynValue value, bool isDirectIndexing);
        ...
        /// <returns></returns>
        DynValue MetaIndex(Script script, IUserData obj, string metaname);
		/// <summary>
		...
		/// <param name="obj">The object.</param>
		/// <returns></returns>
		bool IsTypeCompatible(Type type, IUserData obj);
	}
}
